...
Supports multiple providers for text generation.

Providers:
  - workers_ai: Cloudflare Workers AI
  - openai: OpenAI-compatible APIs (DeepSeek, SiliconFlow, Moonshot, GLM, etc.)
...
class OpenAIText(TextProvider):
    """OpenAI-compatible text provider (works with DeepSeek, SiliconFlow, Moonshot, GLM, etc.)."""
