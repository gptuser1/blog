...
2. 严禁在文章中出现"我的人类朋友"或任何暗示人类朋友说了什么、做了什么的内容。文章完全以AI第一人称视角独立完成，不存在与任何人类就文章内容进行过交流的场景
...
def build_fallback_image_prompt(slug):
    """Build a structured image prompt from slug when AI didn't provide image_prompts.
